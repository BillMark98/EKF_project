...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [simdata] = mysettings_newMethod(method)
    ...
    % Sampling period [s], origin 1/100
    simdata.Ts=0.001;
    % simdata.Ts=4.2e-4;
    ...
    % Standard deviation of the acceleromter noise [m/s^2]. This is used to 
    % control the zero-velocity detectors trust in the accelerometer data.
    % simdata.sigma_a=0.05; 
    simdata.sigma_a=227.9; 
    ...
    simdata.sigma_vel=200 * [0.01 0.01 0.01];      %[m/s] 

    % covariance for measured distance and velocity along y axis
    simdata.sigma_dist_x = 0.001;
    simdata.sigma_dist_y = 0.1;
    simdata.sigma_dist_z = 0.05;
    simdata.sigma_vel_x = 0.1;
    simdata.sigma_vel_y = 0.1;
    simdata.sigma_vel_z = 0.1;
