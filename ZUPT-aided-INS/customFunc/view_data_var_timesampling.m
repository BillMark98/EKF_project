function view_data_var_timesampling(u, timestamps, x_h, cov_h, zupt, simdata)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%> modified based on @file view_data.m  
%>
...
figure(2)
clf
plot(x_h(1,:)-x_h(1,2),x_h(2,:)-x_h(2,2),'.');
hold
% choose the second point as starting point
plot(x_h(1,2)-x_h(1,2),x_h(2,2)-x_h(2,2),'rs')
title('Trajectory')
